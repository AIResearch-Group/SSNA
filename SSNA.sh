...
CUDA_VISIBLE_DEVICES=0 python SSNA.py /data/SSL/cifar10 -d CIFAR10 --train-resizing 'cifar' --val-resizing 'cifar' \
  ...
  --lr 0.03 --finetune --seed 0 --log logs/erm/cifar10_4_labels_per_class --epochs 20 --trade-off-noise-supervised 1 --trade-off-NA-training 1 --alpha 0.7
...
CUDA_VISIBLE_DEVICES=0 python SSNA.py /data/SSL/cifar100 -d CIFAR100 --train-resizing 'cifar' --val-resizing 'cifar' \
  ...
  --lr 0.01 --finetune --seed 0 --log logs/erm/cifar100_4_labels_per_class --epochs 20 --trade-off-noise-supervised 10 --trade-off-NA-training 10 --alpha 0.7

# ======================================================================================================================
# DTD
CUDA_VISIBLE_DEVICES=0 python SSNA.py /data/SSL/dtd -d DTD --num-samples-per-class 4 -a resnet18 \
  --lr 0.03 --finetune --seed 0 --log logs/erm/dtd_4_labels_per_class --epochs 20 --trade-off-noise-supervised 1 --trade-off-NA-training 1 --alpha 0.7

# ======================================================================================================================
# Caltech-101
CUDA_VISIBLE_DEVICES=0 python SSNA.py /data/SSL/caltech101 -d Caltech101 --num-samples-per-class 4 -a resnet18 \
  --lr 0.003 --finetune --seed 0 --log logs/erm/caltech_4_labels_per_class --epochs 20 --trade-off-noise-supervised 1 --trade-off-NA-training 10 --alpha 0.7
